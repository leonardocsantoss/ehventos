...
VERSIONS = getattr(settings, "FILEBROWSER_VERSIONS", {
    'fb_thumb': {'verbose_name': 'Admin Thumbnail', 'width': 60, 'height': '', 'opts': 'crop upscale'},
    'thumbnail': {'verbose_name': 'Thumbnail (140px)', 'width': 140, 'height': '', 'opts': 'upscale'},
    'banner': {'verbose_name': 'Banner', 'width': 800, 'height': '', 'opts': 'upscale'},
    'banner_interno': {'verbose_name': 'Banner interno', 'width': 620, 'height': '', 'opts': 'upscale'},
    'realizacao_apoio': {'verbose_name': 'Realizacao e Apoio', 'width': 250, 'height': '', 'opts': 'upscale'},
    'template_certificado': {'verbose_name': 'Template certificado (1024px)', 'width': 1024, 'height': '', 'opts': 'upscale'},
})
...
ADMIN_VERSIONS = getattr(settings, 'FILEBROWSER_ADMIN_VERSIONS', ['thumbnail', 'template_certificado',])
# Which Version should be used as Admin-thumbnail.
ADMIN_THUMBNAIL = getattr(settings, 'FILEBROWSER_ADMIN_THUMBNAIL', 'thumbnail')
#Template certificado
TEMPLATE_CERTIFICADO = getattr(settings, 'FILEBROWSER_TEMPLATE_CERTIFICADO', 'template_certificado')
# Preview Version
PREVIEW_VERSION = getattr(settings, 'FILEBROWSER_PREVIEW_VERSION', 'thumbnail')
...
MAX_UPLOAD_SIZE = getattr(settings, "FILEBROWSER_MAX_UPLOAD_SIZE", 524288)
